...
# Запуск отсюда напрямую тихо создаёт директории с буквальным именем "/home/asus"
...
LOG_DIR="/home/asus/logs/extractor"
CLAUDE_PATH="claude"
ENV_FILE="/home/asus/.config/aist/env"
