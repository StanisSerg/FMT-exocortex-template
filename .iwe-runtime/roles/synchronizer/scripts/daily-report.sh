...
LOG_DIR="/home/asus/logs/synchronizer"
STRATEGY_DIR="/home/asus/IWE/DS-strategy"

# Agent Workspace: если существует — отчёты идут туда
AGENT_WORKSPACE="/home/asus/IWE/DS-agent-workspace"
...
STRATEGIST_LOG="/home/asus/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /home/asus/IWE/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
