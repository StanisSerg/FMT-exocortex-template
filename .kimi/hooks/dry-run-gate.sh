...
# Sentinel: /tmp/iwe-dry-run-${KIMI_SESSION_ID:-${PPID:-noid}}.flag
...
# === Прямые write-tools: Write, Edit, MultiEdit, NotebookEdit, WriteFile, StrReplaceFile ===
case "$TOOL_NAME" in
    Write|Edit|MultiEdit|NotebookEdit|WriteFile|StrReplaceFile)
